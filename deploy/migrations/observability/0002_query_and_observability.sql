...
CREATE TABLE workflow_trace_events (
    ...
    agent_iteration_id Nullable(UUID),
    runtime_call_id Nullable(UUID),
    sandbox_lease_id Nullable(UUID),
    wait_id Nullable(UUID),
    ...
    content_kind LowCardinality(Nullable(String)),
    content_preview_json Nullable(String),
    content_hash String,
