...
CREATE TABLE node_definition_versions (
    ...
    capability ENUM('builtin', 'declarative_http', 'plugin_nodejs', 'agent', 'model', 'mcp_tool', 'skill', 'rag', 'memory', 'sandbox') NOT NULL,
    ...
    plugin_version_id BINARY(16) NULL,
...
CREATE TABLE node_definitions (
    ...
    source_type ENUM('registry', 'plugin') NOT NULL,
    status ENUM('active', 'disabled') NOT NULL DEFAULT 'active',
    created_at TIMESTAMP(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
    updated_at TIMESTAMP(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),
    PRIMARY KEY (id),
...
CREATE TABLE canvas_plugins (
    ...
    source_type ENUM('builtin', 'imported') NOT NULL DEFAULT 'imported',
    default_version_id BINARY(16) NULL,
    version BIGINT UNSIGNED NOT NULL DEFAULT 1,
    created_by BINARY(16) NOT NULL,
    created_at TIMESTAMP(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
    updated_at TIMESTAMP(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),
    PRIMARY KEY (id),
    UNIQUE KEY uq_canvas_plugin_package (tenant_id, package_id),
    KEY idx_canvas_plugins_tenant_updated (tenant_id, updated_at)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

CREATE TABLE canvas_plugin_versions (
    id BINARY(16) NOT NULL,
    tenant_id BINARY(16) NOT NULL,
    plugin_id BINARY(16) NOT NULL,
    package_version VARCHAR(64) NOT NULL,
    bundle_digest CHAR(71) NOT NULL,
    status ENUM('enabled', 'disabled') NOT NULL DEFAULT 'enabled',
    sdk_api_version INT UNSIGNED NOT NULL,
    manifest_json JSON NOT NULL,
    artifact_key VARCHAR(512) NOT NULL,
    created_by BINARY(16) NOT NULL,
    created_at TIMESTAMP(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
    PRIMARY KEY (id),
    UNIQUE KEY uq_canvas_plugin_version (tenant_id, plugin_id, package_version),
    UNIQUE KEY uq_canvas_plugin_digest (tenant_id, bundle_digest),
    KEY idx_canvas_plugin_versions_plugin (tenant_id, plugin_id, status, created_at)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

CREATE TABLE canvas_plugin_imports (
    id BINARY(16) NOT NULL,
    tenant_id BINARY(16) NOT NULL,
    bundle_digest CHAR(71) NOT NULL,
    artifact_key VARCHAR(512) NOT NULL,
    status ENUM('ready', 'installed', 'failed', 'cancelled') NOT NULL,
    manifest_json JSON NOT NULL,
    issues_json JSON NOT NULL,
    installed_version_id BINARY(16) NULL,
    created_by BINARY(16) NOT NULL,
    expires_at TIMESTAMP(6) NOT NULL,
    created_at TIMESTAMP(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
    updated_at TIMESTAMP(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),
    PRIMARY KEY (id),
    UNIQUE KEY uq_canvas_plugin_import_digest (tenant_id, bundle_digest),
    KEY idx_canvas_plugin_import_expiry (status, expires_at)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

CREATE TABLE canvas_plugin_object_gc (
    id BINARY(16) NOT NULL,
    tenant_id BINARY(16) NOT NULL,
    ...
    created_at TIMESTAMP(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
    PRIMARY KEY (id),
    UNIQUE KEY uq_canvas_plugin_object_gc_key (tenant_id, object_key),
    KEY idx_canvas_plugin_object_gc_claim (available_at, created_at)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
