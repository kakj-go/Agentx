...
export function ApplicationsPage() {
  ...
  const fields: EntityFormField[] = [
    ...
    { name: 'visibility', label: t('applications.visibility'), type: 'select', defaultValue: 'department', options: [{ value: 'private', label: t('applications.private') }, { value: 'department', label: t('applications.departmentVisible') }, { value: 'company', label: t('applications.companyVisible') }] },
  ]
  return <>
