...
export const spanKinds = ['execution', 'node', 'attempt', 'agent_run', 'agent_iteration', 'runtime_call', 'sandbox', 'wait']
export const kindColor: Record<string, string> = { execution: 'bg-primary', node: 'bg-blue-500', attempt: 'bg-cyan-500', agent_run: 'bg-violet-500', agent_iteration: 'bg-purple-400', runtime_call: 'bg-amber-500', sandbox: 'bg-emerald-500', wait: 'bg-orange-500' }
