...
export function ResourceGrantRequestDetailPage() {
  ...
  return <PageContainer>
    <PageHeader action={<Button asChild size="sm" variant="ghost"><Link to="/approvals?tab=resource-grants">{t('studio.back')}</Link></Button>} description={`${value.workflowName} · ${value.requestedByName}`} title={value.primaryResourceName ?? value.primaryResourceId} />
