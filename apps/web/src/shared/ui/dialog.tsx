...
export function DialogContent({ className, children, title, description, ...props }: DialogContentProps) {
  return (
    <DialogPrimitive.Portal>
      ...
      <DialogPrimitive.Content className={cn('fixed left-1/2 top-[18%] z-50 w-[min(560px,calc(100vw-48px))] -translate-x-1/2 rounded-2xl border border-border bg-surface p-0 text-foreground shadow-2xl outline-none', className)} {...props}>
