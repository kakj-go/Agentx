...
const schemaUrl = new URL('../../../contracts/openapi/platform-api.json', import.meta.url)
...
const header = `/** Generated schema components from contracts/openapi/platform-api.json. Do not edit. */\n`
