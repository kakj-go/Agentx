...
export const spanKinds = ['execution', 'boundary', 'node', 'attempt', 'agent_run', 'agent_iteration', 'runtime_call', 'sandbox', 'wait', 'plugin_operation']
export const kindColor: Record<string, string> = { execution: 'bg-primary', boundary: 'bg-fuchsia-500', node: 'bg-blue-500', attempt: 'bg-cyan-500', agent_run: 'bg-violet-500', agent_iteration: 'bg-purple-400', runtime_call: 'bg-amber-500', sandbox: 'bg-emerald-500', wait: 'bg-orange-500', plugin_operation: 'bg-lime-500' }
