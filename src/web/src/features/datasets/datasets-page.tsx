...
export function DatasetsPage() {
  ...
  const fields: EntityFormField[] = [{ name: 'name', label: t('common.name'), required: true }, { name: 'description', label: t('common.description'), type: 'textarea' }, { name: 'visibility', label: t('datasets.visibility'), type: 'select', defaultValue: 'department', required: true, options: [{ value: 'private', label: t('datasets.private') }, { value: 'department', label: t('datasets.departmentVisible') }, { value: 'company', label: t('datasets.companyVisible') }] }]
  return <>
