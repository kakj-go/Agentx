const translations = {
  ...
  "codes": {
    ...
    "AGENT_MODEL_ERROR": "The model call failed. Check the error detail on the execution page.",
    "AGENT_MODEL_RATE_LIMITED": "The model service is rate limited (429). Retry later or switch to another model endpoint.",
